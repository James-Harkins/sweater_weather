  ...
  describe "class methods" do
    describe "#generate_background_image" do
      it "returns a BackgroundImage PORO for the return value of an UnsplashService.get_background_image_data call", :vcr do
        ...
        expect(denver_background_image.image[:image_url]).to eq("https://images.unsplash.com/photo-1602967689755-6bc05c2d3c5b?crop=entropy&cs=tinysrgb&fm=jpg&ixid=MnwzMzY1Mzh8MHwxfHNlYXJjaHwxfHxkZW52ZXIlMkNjbyUyQ3NreWxpbmV8ZW58MHwwfHx8MTY1NTE0Nzc2NA&ixlib=rb-1.2.1&q=80")
        ...
        expect(denver_background_image.image[:credit][:photographer_info][:link]).to eq("https://api.unsplash.com/users/acton_crawford")
      end
    end
  end
end
